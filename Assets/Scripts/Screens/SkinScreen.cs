...
namespace Cube.App
{
    ...
    public sealed class SkinScreen : MonoBehaviour
    {
        ...
        public void Build(RectTransform parent, Action onBack)
        {
            ...
            var section = UiKit.Label(transform, "SkinSection", "색감 고르기", UiMetrics.SectionTitle,
                _p.TextSecondary, TextAnchor.MiddleLeft);
            ...
            UiKit.Stretch((RectTransform)list.transform,
                new Vector2(0.05f, 0.12f), new Vector2(0.95f, 0.45f), Vector4.zero);
            ...
            for (int i = 0; i < _skins.Length; i++)
            {
                ...
                // Keep all six presets fully visible on tall phones without clipping
                // the rounded bottom edge of the final row.
